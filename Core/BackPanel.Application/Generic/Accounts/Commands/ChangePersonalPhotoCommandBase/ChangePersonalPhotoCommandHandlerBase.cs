...
namespace BackPanel.Application.Generic.Authentication.Commands.ChangePersonalPhotoCommandBase
{
    public abstract class ChangePersonalPhotoCommandHandlerBase<TEntity>
        : IRequestHandler<ChangePersonalPhotoCommandBase<TEntity>, string>
        where TEntity : UserEntityBase
    {
        ...
        public async Task<string> Handle(ChangePersonalPhotoCommandBase<TEntity> request, CancellationToken cancellationToken)
        {
