...
{
    public abstract class RegisterCommandHandlerBase<TEntity, TDTORequest, TDTO, TCommand> : IRequestHandler<RegisterCommandBase<TDTORequest, TDTO>, TDTO>
        ...
        where TDTO : UserDtoBase
    {
        ...
        protected RegisterCommandHandlerBase(IRepositoryBase<TEntity> repository, IMapper mapper, IWebConfiguration webConfiguration)
        {
