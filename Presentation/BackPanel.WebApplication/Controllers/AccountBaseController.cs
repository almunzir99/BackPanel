...
using BackPanel.Application.Generic.Accounts.Queries.GetProfileQueryBase;
using BackPanel.Application.Generic.Authentication.Commands.AuthenticateCommandBase;
using BackPanel.Application.Generic.Authentication.Commands.ChangePersonalPhotoCommandBase;
using BackPanel.Application.Generic.Authentication.Commands.PasswordRecoverCommandBase;
using BackPanel.Application.Generic.Authentication.Commands.PasswordRecoveryRequestCommandBase;
using BackPanel.Application.Generic.Authentication.Commands.PasswordResetCommandBase;
using BackPanel.Application.Generic.Authentication.Commands.RegisterCommandBase;
