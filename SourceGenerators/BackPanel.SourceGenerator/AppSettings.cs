...
public static class AppSettings
{
    ...
    public const string QueriesRelativePath = "Core/ProjectName.Application/Features/FeaturePuralName/Queries";
    public const string CommandsHandlerRelativePath = $"{CommandsRelativePath}/Handlers";
    public const string QueriesHandlerRelativePath = $"{QueriesRelativePath}/Handlers";
