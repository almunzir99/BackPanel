...
public class UnitOfWork : IUnitOfWork
{
    ...
    {
        AdminsRepository = new RepositoryBase<Admin>(dbContext, mapperHelper);
        MessagesRepository = new RepositoryBase<Message>(dbContext, mapperHelper);
        RolesRepository = new RepositoryBase<Role>(dbContext, mapperHelper);
        PermissionsRepository = new RepositoryBase<Permission>(dbContext, mapperHelper);
        NotificationsRepository = new RepositoryBase<Notification>(dbContext, mapperHelper);
        CompanyInfosRepository = new RepositoryBase<CompanyInfo>(dbContext, mapperHelper);
